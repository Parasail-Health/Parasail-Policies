...
HIPAA compliance is complicated, but it doesn't have to be. Parasail helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of Parasail or our business and change to appropriate references to your company.
3. Publish your policies in a publicly available location. The files are markdown, so you may need to convert to HTML if you don't have a publishing platform capable of markdown format. You can either create an index page linking to each individual policy, or create a single page listing all the policies in line, [much like we did](https://parasail.io/policy/).

## Who is behind this?

[Parasail.io](htts://parasail.io), healthcare's trusted HIPAA-compliant platform.
...
To get in touch, shoot us an email at [hello@parasail.io](mailto:hello@parasail.io). We'd love to hear from you!
...
* [Parasail HIPAA Business Associate Agreement (“BAA”)](source/sections/parasail_hipaa_business_associate_agreement.md)
* [HIPAA Mappings to Parasail Controls](source/sections/hipaa_mapping_to_parasail_controls.md)
